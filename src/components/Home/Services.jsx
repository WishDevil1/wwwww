...
const Service = () => {
  return (
    <section className="pb-4 pt-4 dark:bg-dark lg:pb-[90px] lg:pt-[120px]">
      <div className="container mx-auto">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
        ...
        <div className="-mx-4 flex flex-wrap">
          <ServiceCard
            image="https://w7.pngwing.com/pngs/839/53/png-transparent-computer-icons-refresh-save-miscellaneous-blue-thumbnail-thumbnail.png"
            title="Refreshing Design"
