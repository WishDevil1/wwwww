...
//                           </span>
//                         </span>
//                         <div className="flex items-center gap-4 pt-4 text-sm text-left text-emerald-500">
//                           <img
...
//                             </span>
//                             <cite className="not-italic">
//                               <a href="#">WAI-ARIA, Representative</a>
//                             </cite>
//                           </div>
//                         </div>
//                       </figcaption>
...
// import React, { useEffect } from "react";
// import Glide from "@glidejs/glide";
// import picOne from "../../assets/slider/picOne.png";
// import picTwo from "../../assets/slider/picTwo.png";
// import picThree from "../../assets/slider/picThree.png";
...
import picTwo from "../../assets/slider/picTwo.png";
import picThree from "../../assets/slider/picThree.png";
import picFour from "../../assets/slider/picOne.png"; // Add import for the fourth image
        ...
        <div className="overflow-hidden" data-glide-el="track">
          <ul className="whitespace-no-wrap flex-no-wrap [backface-visibility: hidden] [transform-style: preserve-3d] [touch-action: pan-Y] [will-change: transform] relative flex w-full overflow-hidden p-0">
            <li>
              <img
                src={picOne}
                className="w-full max-w-full h-60 m-auto object-cover rounded-md"
                alt="Slide 1"
              />
            </li>
            <li>
